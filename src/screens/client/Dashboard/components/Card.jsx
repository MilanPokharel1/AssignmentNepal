...
const Card = ({ Icon, heading, number, theme }) => {
  return (
    <div
      className={`flex items-center ${theme.bgColor} p-4 rounded-lg shadow-md  h-36 sm:h-32 lg:h-36 mb-4 sm:mb-0 w-[40vw] sm:w-[23rem] md:w-[20rem] sm:max-md:w-[25rem] sm:max-md:mx-auto`}
    >
